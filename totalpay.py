...
def pay_pan():
    currencies = list((None, None))  # We intend to store two numbers in this list and no more, though You could maybe alternatively use .append() in input_test on an empty list
    ...
    total_pay = str(currencies[0] + currencies[1])  # It is fine to assume the values are integers as we already made sure
